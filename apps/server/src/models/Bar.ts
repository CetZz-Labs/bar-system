...
// Exportado para que Outing.ts (LB-65) lo reutilice tal cual en
// `attendancePointsSnapshot`, en vez de duplicar la definición de los 7
// campos día-por-día.
export const attendancePointsByDaySchema = new Schema<IAttendancePointsByDay>({
