...
4. Si la tarea tocó `apps/server`, releé `.opencode/rules/backend.md`; si tocó
   `apps/client`, releé `.opencode/rules/frontend.md`. Los checkpoints de
...
1. Eliminar apps/server/src/services/ y mover la lógica al controller
   correspondiente, según .opencode/rules/backend.md.
```
