...
No tenés acceso a Bash: no podés ejecutar nada. Tu único uso permitido de
escritura es tu propio archivo de reporte en `progress/explorers/` — no podés
tocar ningún otro archivo del disco.
